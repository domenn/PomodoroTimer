...
int display()
{
    ...
    const wchar_t * appName = L"Console WinToast Example";
    const wchar_t *    appUserModelID = L"WinToast Console Example";
    const wchar_t *text = NULL;
    const wchar_t *imagePath = NULL;
    const wchar_t *attribute = L"Some hardcoded text";
...
extern "C" {    // another way
    __declspec(dllexport) void libn_show(char const* title, char const* text, LibnNotificationButton* buttons) {
        display();
    }
};
